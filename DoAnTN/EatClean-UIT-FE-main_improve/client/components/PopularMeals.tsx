  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20">
      <div className="max-w-[1728px] mx-auto px-4 sm:px-8 lg:px-16 xl:px-32">
        <h3 className="text-3xl sm:text-4xl lg:text-[40px] font-bold tracking-[0.23em] bg-gradient-to-r from-[#2596BE] to-[#6F3AFA] bg-clip-text text-transparent font-satoshi mb-4 sm:mb-6 py-2">
          PHỔ BIẾN NHẤT
        </h3>
