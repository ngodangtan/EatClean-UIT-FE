...
const ACTIVITY_LEVELS = [
  ...
  { value: "extremely-active", label: "Extremely Active (athlete/hard labor)" },
];
        ...
        <div className="max-w-[1728px] mx-auto">
          ...
          {loading ? (
            ...
            <form onSubmit={handleSubmit} className="max-w-3xl mx-auto space-y-10 sm:space-y-12">
              ...
              {/* Activity & Lifestyle */}
              <div>
                <h2 className={sectionClass}>Activity & Lifestyle</h2>
                <div className="space-y-6 sm:space-y-8">
                  ...
                  <div>
                    <label className={labelClass}>Sleep Duration (hours/night)</label>
                    <input
              ...
              {/* Diet Preferences */}
              <div>
                <h2 className={sectionClass}>Diet Preferences</h2>
                <div className="space-y-6 sm:space-y-8">
                  <div>
                      ...
                      {CUISINE_OPTIONS.map((c) => {
                        ...
                        return (
                          <button
                            ...
                            className={`px-5 py-3 rounded-2xl border-2 text-base sm:text-lg font-inter font-medium transition-all ${
                              selected
              ...
              {/* Health Conditions */}
              <div>
                <h2 className={sectionClass}>Health Conditions</h2>
                  ...
                  {DISEASE_CATALOG.map((d) => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex items-center gap-3 px-5 py-4 rounded-2xl border-2 text-left text-base sm:text-lg font-inter font-medium transition-all ${
                          selected
                      ...
                      >
                        <span
                          className={`w-5 h-5 rounded-md border-2 flex-shrink-0 flex items-center justify-center ${
                            selected ? "border-[#6F3AFA] bg-[#6F3AFA]" : "border-gray-300"
                          }`}
                        >
                          {selected && (
                ...
                <div className="space-y-6 sm:space-y-8">
                  ...
                  <div>
                    ...
                    <div className="w-full h-16 sm:h-20 lg:h-[77px] bg-[#F3F3FD] rounded-[29px] border border-gray-200 flex items-center px-6 sm:px-8">
                      <p className="text-base sm:text-lg lg:text-2xl text-gray-700 font-inter">
                        {profile.sleepDuration} hours/night
                      </p>
                    </div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3 mt-2">
                      {profile.cuisinePreference.length === 0 ? (
                        <p className="text-gray-400 font-inter text-base sm:text-lg italic">No cuisines selected</p>
                      ) : (
                          ...
                          <div className="flex items-center gap-3 flex-wrap">
                            ...
                            {d.diagnosedAt && (
                              <span className="ml-auto text-sm text-gray-400 font-inter">
                                Diagnosed: {new Date(d.diagnosedAt).toLocaleDateString()}
                              </span>
                            )}
                          </div>
